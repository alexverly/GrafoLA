    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("[02] Inserir vértice");
                Console.WriteLine("[03] Remover vértice");
                Console.WriteLine("[04] Inserir aresta");
                Console.WriteLine("[05] Remover aresta");
                Console.WriteLine("[06] Imprimir grau de um vértice");
                Console.WriteLine("[07] Verificar se o grafo é completo");
                Console.WriteLine("[08] Verificar se o grafo é regular");
                Console.WriteLine("[09] Imprimir Lista de Adjacências");
                Console.WriteLine("[10] Imprimir Sequência de Graus");
                Console.WriteLine("[11] Imprimir Vértices Adjacentes de um vértice");
                Console.WriteLine("[12] Verificar se um vértice é isolado");
                Console.WriteLine("[13] Verificar se um vértice é ímpar");
                Console.WriteLine("[14] Verificar se um vértice é par");
                Console.WriteLine("[15] Verificar se dois vértices são adjacentes");
                Console.WriteLine("[16] Imprimir grafo");
                Console.WriteLine("[00] Sair\n");

                Console.Write("\nDigite a opção desejada: ");
                testeOpcao = int.TryParse(Console.ReadLine(), out opcao);

                while (opcao < 0 || opcao > 16 || testeOpcao == false)
                {
